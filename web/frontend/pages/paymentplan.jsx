  ...
  return (
    <Page>
      ...
      <Box paddingBlock={600}>
        <Text as='p' alignment="center">All charges are billed in USD. Recurring and usage-based charges are billed every 30 days.</Text>
      </Box>
      ...
      <InlineStack align='center' gap={"400"}  blockAlign="stretch">
        ...
        <Paymentcard  list={primiumPlan} title={"Primium" } price={"$27.99 /month"}/>
